            ...
            <div class="container">
                <% if (null != request.getSession().getAttribute("user")) {%>
                    <nav>
                        ...
                        <a href="/message/list.do">返回所有留言</a>
                ...
                <c:forEach items="${messages}" var="msg">
                    <div class="alt-item">
                        ...
                        <div class="alt-content">
                            ...
                            <table>
                            <tr><td>
                            <form id="${msg.id}_form" action="/my/editMessagePrompt.do" method="post">
                            ...
                            <td>
                            <form id="${msg.id}_del_form" action="/my/deleteMessage.do" method="post">
                                <input type="hidden" name="id" value="${msg.id}">
